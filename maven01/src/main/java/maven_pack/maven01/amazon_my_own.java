...
//		driver.findElement(By.xpath("//span[text()='RESULTS']//ancestor::div[@class='s-main-slot s-result-list s-search-results sg-row']//img[@data-image-index='1']")).click();
		...
		WebElement findElement4 = driver.findElement(By.xpath(
				"(//span[text()='RESULTS']/following::div/following::div/child::div/following::div/child::div/child::div/child::div/following::span/preceding::h2/child::a)[1]"));
		String firsttitle =findElement4.getText();
		System.out.println("second title"+findElement4.getText());
		findElement4.click();
		...
		WebElement findElement5 = driver.findElement(By.xpath("//span[@id='productTitle']"));
		String secondtitle = findElement5.getText();
		System.out.println("thirdtitle"+secondtitle);
